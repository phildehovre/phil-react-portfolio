...
const Tastify = () => {
  return (
    <div className="tastify-global-ctn">
      <h1 className="metro-title-ctn">Under construction</h1>
      <div className="projects-text-box">
        Tasteify here is some new development of a brand new concept called "Tastify". The idea behind this app is to promote the "good living" or "hygge".
